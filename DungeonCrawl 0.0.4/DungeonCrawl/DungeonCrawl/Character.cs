...
namespace DungeonCrawl
{
    class Character : MovingGameObj
    {
        ...
        public void MoveRight() //Medtod om man rör sig till höger
        {
            ...
            { moveCharRight = false; moved = 0; allowButtonPress = true; } //olika variabler ändras så att man nu kan genomföra en ny rörelse
        ...
        public void MoveLeft()  //Medtod om man rör sig till left
        {
            ...
            if (moved == 64)    // när man rört sig 64 pixlar så stannar gubben
            { moveCharLeft = false; moved = 0; allowButtonPress = true; }   //olika variabler ändras så att man nu kan genomföra en ny rörelse
            Position = new Vector2(Xpos -= 4, Position.Y);  //positionen för karaktären ökar med 4 för varje tick av gametime
        }
        ...
        public void MoveUp()    //Medtod om man rör sig upp
        {
            ...
            if (moved == 64)    // när man rört sig 64 pixlar så stannar gubben
            { moveCharUp = false; moved = 0; allowButtonPress = true; } //olika variabler ändras så att man nu kan genomföra en ny rörelse
        ...
        public void MoveDown()  //Medtod om man rör sig ner
        {
            ...
            if (moved == 64)    // när man rört sig 64 pixlar så stannar gubben
            { moveCharDown = false; moved = 0; allowButtonPress = true; }   //olika variabler ändras så att man nu kan genomföra en ny rörelse
